...
const RightSiedeMobile = ({ checked, hotelData, lat, lng }) => {
      ...
      <div className="d-flex justify-content-start">
        <div className={resulationMd ? "listRithTopMid" : "listRithTop"}>
          ...
          <div className="d-flex mt-3">
            <div
              className="d-flex justify-center items-center custom_orange_color px-1 py-1 border-r-2 text-center text-xs text-light"
              style={{ width: "16.66%" }}
            >
              Sort
            </div>
            ...
            <div
              className="d-flex justify-center items-center custom_orange_color px-1 py-1 text-center text-xs text-light"
              style={{ width: "16.66%" }}
            >
              Hot Deals!
            </div>
              ...
              >
                ...
                >
                  ...
                  />{" "}
                  {
                    ...
                    >
                      <h1 className="text-light text-xs">Breakfast Included</h1>
                    </div>
                  }
                  {items?.images?.length > 1 && (
                    <div className="d-flex mt-3 border-t-2 pt-2">
                      {items?.images[1] && (
                        <img
                          src={items?.images[1]}
                          alt=""
                      ...
                      {items?.images[2] && (
                        <img
                          ...
                          className="rounded-2 rounded-2 ml-1 "
                        />
                      )}
                      <>
                        {items?.images?.length <= 3 ? (
                          <img
                            ...
                            className="rounded-2 ml-1"
                          />
                        ) : (
                          <div
                            className="rounded-2 ml-1 d-flex align-items-center justify-content-center"
                            style={{
                              width: "100%",
                              height: "50px",
                          ...
                          >
                            <h1 className="text-center my-auto text-light">
                              See all
                            </h1>
                          </div>
                        )}
                    ...
                    <div className="border-b pb-3">
                      ...
                      <div className="d-flex align-items-center ">
                        ...
                        <span className=" hover:text-blue-800 text-center cursor-pointer">
                          <LocationOnIcon className="ml-1  text-blue-800" />{" "}
                      ...
                      <button className="custom_orange_color text-light text-xs px-2 py-1 rounded-full mt-3">
...
export default RightSiedeMobile;
